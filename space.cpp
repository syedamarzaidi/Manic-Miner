...
int Cannon_UpperTip_y = 28;
int Cannon_LeftTip_x = 26;
int Cannon_LeftTip_y = 27;
int Cannon_MidTip_x = 26;
int Cannon_MidTip_y = 28;
int Cannon_RightTip_x = 26;
int Cannon_RightTip_y = 29;
...
void CannonMoveLeft(){
    if(board[Cannon_UpperTip_x][Cannon_UpperTip_y-2] != '?'){
